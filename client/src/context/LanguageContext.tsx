...
export const CORE_UI_STRINGS: string[] = [
  ...
  "NYC HRA Caseworker (hra_nyc)",
  "Queens CBO Caseworker (queens_cbo)",
  ...
  "Organization Scope (Mandatory for Caseworkers)",
  "Under Cedar Policy #2, Caseworkers can only view and process cases belonging to their assigned organization.",
  "NYC HRA Agency",
  "Queens Non-Profit",
  "Custom Org",
  "Specify ID",
  "Enter organization slug (e.g. bronx_aid_net)",
  "Registering Identity...",
  "Create Staff Account",
  "Authorization Barrier Enforced:",
  "Please provide both email and password.",
  "Authentication successful! Redirecting to your authorized workspace...",
  "Full name is required.",
  "Valid email is required.",
  "Password must be at least 8 characters long.",
  "Caseworker registration requires an organization ID (e.g. 'hra_nyc').",

  // Program Details & Eligibility Evaluator
  "Program Overview",
  "Statutory Income Threshold",
  "Required Verification Documents",
  "Standard NYC identification and residency proof.",
  "Hotline Phone",
  "Official Portal",
  "Launch Online Application",
  "Close",
  "Test My Eligibility for this Benefit",
  ...
  "Borough / Region",
  "Monthly Rent ($)",
  "Receives Disability (SSI/SSDI)",
  "Has Children Under 5",
  "Owns Home (Primary)",
  "Evaluating Rules...",
  "Run Deterministic Eligibility Check",
  "Eligible under Deterministic Statutory Rules",
  "Not Currently Eligible for this Benefit",
  "Criteria Satisfied:",
