      ...
      <div className="relative w-full max-w-2xl bg-slate-900 border border-slate-700 rounded-3xl shadow-2xl p-6 overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-start justify-between pb-4 border-b border-slate-800">
          <div>
            ...
            <h3 className="text-xl font-bold text-white mt-1.5">{program.name}</h3>
        ...
        <div className="flex-1 overflow-y-auto py-4 space-y-5">
          ...
          {program.income_threshold && (
            <div className="p-3.5 rounded-2xl bg-slate-950/80 border border-slate-800">
              <div className="text-xs font-semibold text-amber-400 flex items-center gap-1.5 mb-1">
                ...
                <span>Statutory Income Threshold</span>
              </div>
              <p className="text-xs text-slate-300">{program.income_threshold}</p>
            </div>
          )}
          ...
          <div>
            ...
            {reqs?.required_documents || program.required_documents ? (
              ...
              <p className="text-xs text-slate-400">Standard NYC identification and residency proof.</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs">
            {program.contact_phone && (
              <div className="flex items-center gap-2 p-3 rounded-xl bg-slate-950 border border-slate-800 text-slate-300">
                ...
                <div>
                  <div className="text-[10px] text-slate-400 uppercase font-semibold">Hotline Phone</div>
            ...
            {program.application_url && (
              ...
              >
                <div>
                  <div className="text-[10px] text-slate-400 uppercase font-semibold">Official Portal</div>
                  <div className="font-semibold text-emerald-400">Launch Online Application</div>
                </div>
        ...
        <div className="pt-4 border-t border-slate-800 flex items-center justify-end gap-3">
          ...
          >
            Test My Eligibility for this Benefit &rarr;
          </button>
        </div>
      </div>
    </div>
